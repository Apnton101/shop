...
Route::group(['prefix' => '/colors'], function() {
    ...
    Route::get('/show/{color}', \App\Http\Controllers\Color\ShowController::class)->name('color.show');
...
Route::group(['prefix' => '/users'], function() {
    ...
    Route::get('/show/{user}', \App\Http\Controllers\User\ShowController::class)->name('user.show');
